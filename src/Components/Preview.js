...
const Preview = ({ themeSettings, preview }) => (
    <div className='preview-container'>
        ...
        <div className={`view-container ${themeSettings.id} ${preview === "desktop" ? "desktop" : "mobile"}`}>
            <p className='view-container-item'>{themeSettings.title} Theme</p>
            <p className='view-container-item'>{themeSettings.datePickerTitle}: 07/11/2020</p>
