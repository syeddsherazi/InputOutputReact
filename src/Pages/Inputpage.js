      ...
      <div className="inputpage-container">
        ...
        <div className="form-container">
          ...
          <Textarea
            ...
            setState={setContextState}
          />
          {submitted && !contextState.text && (
            <span className="help-block">* Message can't be empty</span>
          )}
        </div>
        <div className="form-container">
          ...
          <RadioButtons
            ...
            setOpen={setOpen}
          />
          {submitted && !contextState.theme && (
            <span className="help-block">* Please select a theme</span>
          )}
        </div>
